...
export default Vue.extend({
  ...
  //       `https://api-instagram-app.herokuapp.com/postdetail/${params.id}`
  //     )
  ...
  created() {
    ...
    // this.getPostDetail()
    // 現在ログインしているユーザー名取得
    this.this.loginUserName = this.$store.getters['user/getLoginUserName']
  ...
  //   async asyncData({ params }) {
  //     await console.log('params取得' + params.postDetail_id)

  //  const response=   await axios.get(
  //       `https://api-instagram-app.herokuapp.com/postdetail/${params.postDetail_id}`
  //     )
  //     return { post :respone.data}
  ...
  //      */
  //     async getPostDetail({ params }: any) {
  //       console.log('params' + params)
  //       const response = await axios.get(
  //         `https://api-instagram-app.herokuapp.com/postdetail/${params}`
  //       )
  //       // responseの投稿内容
