...
export default Vue.extend({
  ...
  methods: {
    ...
    async getPostDetail() {
      ...
      this.currentPostUserInfo = response.userinfo
      console.dir(
        'this.currentPostDetail' + JSON.stringify(this.currentPostDetail)
      )
    },
    // いいね
    // clickLiked() {
