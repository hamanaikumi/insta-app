  ...
  methods: {
    ...
    async getComment() {
      ...
      for (const comment of resComments) {
        console.log('直接format:' + moment(comment.commentDate).format('yyyy-MM-dd HH:mm:ss"))
        // console.log(
        //   'format後:' + format(comment.commentDate, 'yyyy-MM-dd HH:mm:ss')
        // )

        // console.log('moment():' + moment(comment.commentDate))
        // const formatDate = format(comment.commentDate, 'yyyy-MM-dd HH:mm:ss')
