<template>
  <section>
    <div id="content">
      ...
      <div v-for="comment of commentList" :key="comment.userId">
        <div class="flex">
          <div>
            <img
        ...
        <div class="font-extralight">{{ comment.commentDate.fromNow() }}</div>
      </div>
    ...
    async getComment() {
      ...
      for (const comment of resComments) {
        const commentInfo: commentInfo = {
          ...
          commentDate: moment.tz([comment.commentDate], 'Asia/Tokyo'),
