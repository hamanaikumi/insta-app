  ...
  <div class="post-container">
    ...
    <div class="activity-container">
      ...
      <div class="liked-container">
        <span>
          Liked by
          {{ currentPostDetail.favorites }}!</span
        >
      </div>
    </div>
...
export default Vue.extend({
  ...
  methods: {
    ...
    async getPostDetail() {
      ...
      this.currentPostDetail :PostDetail= response.data
      console.dir('post内容' + JSON.stringify(this.currentPostDetail))
