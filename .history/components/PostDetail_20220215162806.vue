    ...
    <div class="top-container flex flex-row">
      ...
      <div class="top-item-container">
        ...
        <div class="prefecture-name">
          {{ currentPostDetail.prefecture.name }}
        </div>
      </div>
    </div>
    <!-- 投稿画像 -->
...
export default Vue.extend({
  ...
  created() {
    ...
    this.getPostDetail()
    // console.dir('投稿詳細:' + JSON.stringify(this.currentPostDetail))
    // 現在ログインしているユーザー名取得
  ...
  methods: {
    ...
    async getPostDetail() {
      ...
      console.dir(
        'prefecture name:' + JSON.stringify(responsePostDetail.prefecture.name)
      )
      // 投稿日時format化
      const MONTH_EN_LIST = [
        'January',
