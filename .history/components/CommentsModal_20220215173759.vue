...
export default Vue.extend({
  ...
  methods: {
    ...
    async getComment() {
      ...
      // 現在のコメント一覧
      const commentOb = response.data.comments
      console.dir('コメント一覧' + JSON.stringify(commentOb))
      console.dir('コメント一覧' + JSON.stringify(commentOb.userinfo))
      // コメントのユーザー情報
      // const commentUserInfo = response.data.userinfo
      // console.dir(
      //   'コメントしたユーザー情報取得する' + JSON.stringify(commentUserInfo)
      // )
      //   this.commentUserInfo.userId = commentUserInfo.userId
      //   this.commentUserInfo.userName = commentUserInfo.userName
      //   this.commentUserInfo.userIconUrl = commentUserInfo.icon
    },
  },
})
</script>
